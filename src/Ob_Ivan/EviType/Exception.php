...
class Exception extends GlobalException
{
    ...
    const VIEW_SERVICE_OFFSET_UNSET_UNSUPPORTED         = 0x010504;
    const VIEW_SERVICE_REGISTER_NAME_ALREADY_EXISTS     = 0x010505;
    const VIEW_SERVICE_SET_VALUE_WRONG_TYPE             = 0x010506;
}
