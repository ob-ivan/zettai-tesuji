...
{
    const TYPE_FROM_VALUE_WRONG_TYPE                    = 0x010101;
    const TYPE_GET_NAME_UNKNOWN                         = 0x010102;
    ...
    const VIEW_SERVICE_OFFSET_GET_OFFSET_UNKNOWN        = 0x010502;
    const VIEW_SERVICE_OFFSET_SET_NAME_ALREADY_EXISTS   = 0x010503;
    const VIEW_SERVICE_OFFSET_SET_VALUE_WRONG_TYPE      = 0x010504;
    const VIEW_SERVICE_OFFSET_UNSET_UNSUPPORTED         = 0x010505;
    const VIEW_SERVICE_REGISTER_NAME_ALREADY_EXISTS     = 0x010506;
}
